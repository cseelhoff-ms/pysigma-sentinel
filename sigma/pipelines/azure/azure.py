        ...
        items=[
                  ...
                  ProcessingItem(  # Field mappings
                      ...
                      transformation=FieldMappingTransformation({
                            ...
                            'Imphash': 'TargetProcessIMPHASH',
                            'md5': 'TargetProcessMD5',
                            'sha256': 'TargetProcessSHA256',
                            'sha1': 'TargetProcessIMPHASH', # prevents error for nonexisting sha1 hash
                  ...
                  ProcessingItem(
                      ...
                      transformation=AddAzureLogsource({'__azure_logsource': '_Im_ProcessCreate'}),
